sap.ui.controller("router.view.third", {
...
*/
	onInit: function() {
		...
		//takes model with key id as number on which routing is applied as key name "data"
	...
	_handleRouteMatched: function(oEvt) {
	      ...
	      this.id = oEvt.getParameter("arguments").id;
	        ...
	        tabConteiner.setSelectedKey("tab"+this.id);
